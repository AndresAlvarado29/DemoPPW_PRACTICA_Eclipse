...
a persistence unit "demoPPWPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demoPPW/pom.xml":
...
artifact ("demoPPW.war") is already built. You can build
